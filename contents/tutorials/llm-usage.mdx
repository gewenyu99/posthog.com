...
tags:
  ...
  - sql
codeExamples: [
  "https://raw.githubusercontent.com/gewenyu99/llm-analytics-demo/refs/heads/main/app/page.tsx",
  "https://raw.githubusercontent.com/gewenyu99/llm-analytics-demo/refs/heads/main/app/api/chat/route.ts",
  "https://raw.githubusercontent.com/gewenyu99/llm-analytics-demo/refs/heads/main/app/api/usage/route.ts",
  "https://raw.githubusercontent.com/gewenyu99/llm-analytics-demo/refs/heads/main/app/usage/page.tsx"
]
---
...
<DemoReference file="app/page.tsx" language="tsx" lines="1-82">

## Adding a chat UI

Here's a simple chat UI that lets users prompt a model and see a response built with Next.JS and simple Tailwind styling. 
</DemoReference>

<DemoReference file="app/page.tsx" language="tsx" lines="47-71">

The chat interface takes a nickname and a short message, which is submitted as an HTML form.
</DemoReference>

<DemoReference file="app/page.tsx" language="tsx" lines="18-40">

This form submission is handled by `handleSubmit`, which parses the form and posts the data to the `/api/chat` endpoint.
</DemoReference>
